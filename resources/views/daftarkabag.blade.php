    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Daftar Kepala Bagian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title">Daftar Kabag</h5>
              ...
              <table class="table table-hover" id="my_table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Parpol</th>
               
                  </tr>
                </thead>
                <tbody>@foreach ($kabag as $item)
